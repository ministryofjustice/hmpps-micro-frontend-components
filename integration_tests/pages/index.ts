  ...
  footer = {
    ...
    supportLinks: {
      ...
      get accessibilityLink(): PageElement<HTMLAnchorElement> {
        return this.list.find('a[href="https://external/new-dps/accessibility-statement"]')
      },

      get termsAndConditionsLink(): PageElement<HTMLAnchorElement> {
        return this.list.find('a[href="https://external/new-dps/terms-and-conditions"]')
      },

      get privacyPolicyLink(): PageElement<HTMLAnchorElement> {
        return this.list.find('a[href="https://external/new-dps/privacy-policy"]')
      },

      get cookiesPolicyLink(): PageElement<HTMLAnchorElement> {
        return this.list.find('a[href="https://external/new-dps/cookies-policy"]')
      },
    },
  }
}
